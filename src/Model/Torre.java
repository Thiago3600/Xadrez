...
public class Torre extends Pecas {
    ...
    public Torre(int cor, int indexX, int indexY, Tabuleiro tab) {

        setCor(cor);

        if (getCor() == 0) {
            setIcon(new ImageIcon(getClass().getResource("/Imagem/Xadrez_pecas/Brancas/Torre_Branca.png")));
        } else if (getCor() == 1) {
            setIcon(new ImageIcon(getClass().getResource("/Imagem/Xadrez_pecas/Pretas/Torre_Pretas.png")));
        }
    ...
    public void mover(Point p, boolean mousePressionado, int[] click, Tabuleiro tab) {
        ...
        if (mousePressionado) {
            ...
            if (getTURNO() == getCor()) {
                ...
                else if (click[1] == getIndexY() && click[0] != getIndexX() && click[0] >= 1 && click[0] <= 8) {
